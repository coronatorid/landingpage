    ...
    <footer className="pt-5 w-full bg-lightCoral dark:bg-gray-900 text-gray-200">
        <div className="container mx-auto px-8">
            <div className="w-full flex flex-col md:flex-row py-3">
                ...
                <div className="flex-1 pr-5 pb-5 text-white">
                ...
                <div className="flex-1">
                    ...
                    <ul className="list-reset mb-6">
                        <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="https://kitabisa.com/campaign/coronator" className="no-underline hover:underline text-white text-grey-darkest hover:text-teal-dark">Support</a>
                        </li>
                        <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="https://github.com/coronatorid" className="no-underline hover:underline text-white text-grey-darkest hover:text-teal-dark">GitHub</a>
                        </li>
                    </ul>
                </div>
                ...
                <div className="flex-1">
                    ...
                    <ul className="list-reset mb-6">
                        <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="/terms" className="no-underline hover:underline text-white text-grey-darkest hover:text-teal-dark">Terms</a>
                        </li>
                        <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="/privacy" className="no-underline hover:underline text-white text-grey-darkest hover:text-teal-dark">Privacy</a>
                        </li>
                    </ul>
                </div>
                ...
                <div className="flex-1">
                    ...
                    <ul className="list-reset mb-6">
                        <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="https://twitter.com/coronatorid" className="no-underline hover:underline text-white text-grey-darkest hover:text-teal-dark">Twitter</a>
                        </li>
                    </ul>
                </div>
